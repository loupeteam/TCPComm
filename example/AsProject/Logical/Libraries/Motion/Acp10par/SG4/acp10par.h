...
#define ACP10PAR_MOTOR_TEMPMODEL_REF_OFF   1706 /* (REAL) Motor: Temperature model: Reference sensor: Temperature offset [K] */
...
#define ACP10PAR_MPGEN_JERK                5272 /* (REAL) FB MPGEN: Jerk [Units/s³] */
