...
_BUR_PUBLIC unsigned long CpuGetNumberOfCores(void);
_BUR_PUBLIC unsigned long CpuGetLoadByCore(unsigned long core);
_BUR_PUBLIC plcbit CpuIsCoreReserved(unsigned long core);


/* Constants */
#ifdef _REPLACE_CONST
 #define profERR_PARAMETER 31050U
 #define profERR_VERSION_NOT_SUPPORTED 31020U
 ...
 _GLOBAL_CONST unsigned short profERR_VERSION_NOT_SUPPORTED;
