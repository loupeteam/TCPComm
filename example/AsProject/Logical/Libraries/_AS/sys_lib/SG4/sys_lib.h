...
#define ERR_EXC_NIL_POINTER 9133	/* null pointer */
#define ERR_BUR_PVNAME 14700      	/* Invalid name syntax */
#define ERR_BUR_WRONG_ARRAY 14702 	/* Invalid array syntax */
#define ERR_BUR_WRONG_ELEM 14703  	/* Invalid element syntax */
#define ERR_BUR_WRONG_COMP 14704  	/* Invalid component separator */
#define ERR_BUR_NOTFOUND 14710    	/* PV not found */
#define ERR_BUR_ZEROLNG 14712     	/* PV size is zero (plausibility check) */
#define ERR_BUR_NODETAIL 14713    	/* No type description (plausibility check) */
#define ERR_BUR_AIXTOOBIG 14714   	/* Array index too big */
#define ERR_BUR_WRONG_SDSR 14715  	/* Invalid address (plausibility check) */
#define ERR_BUR_BUFLNG 14716      	/* Name buffer too small */
#define ERR_BUR_WRONG_INDEX 14717 	/* Access via index/subindex is not supported */
...
#define SYSLIB_SERVICE 0x40				/*SERVICE(with restart) */
	...
	_BUR_PUBLIC UINT PV_lkaddr(void *pv_address, char *pv_name_buf, UDINT pv_name_buf_size);
